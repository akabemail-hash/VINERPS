...
import { Edit2, Trash2, Plus, Filter, Download } from 'lucide-react';
import { Pagination } from '../components/Pagination';

export const Inventory = () => {
  const { products, categories, brands, units, addProduct, updateProduct, language, settings } = useStore();
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
            <button className="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 flex items-center shadow-sm text-sm font-medium">
