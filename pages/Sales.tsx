...
import { Search, ArrowLeftRight, Plus, Trash2, CheckCircle, User, CreditCard, Banknote, Eye, X, FileText, ChevronDown } from 'lucide-react';
import { Pagination } from '../components/Pagination';

export const Sales = () => {
  const { invoices, addInvoice, language, settings, customers, products } = useStore();
             ...
             <table className="w-full text-left border-collapse">
                 <thead>
                     <tr className="bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700">
                         ...
                         <th className="p-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">{t('type')}</th>
